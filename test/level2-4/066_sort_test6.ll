...
B113:                               	; preds = %B105
  %t214 = add i32 0, 0
  %t15 = icmp slt i32 0, 10
  br i1 %t15, label %B114, label %B118
B114:                               	; preds = %B113, %B233
  %t17 = getelementptr inbounds [10 x i32], [10 x i32]* %t109, i32 0, i32 %t214
  store i32 0, i32* %t17, align 4
  %t20 = add i32 %t214, 1
  %t120 = icmp slt i32 %t20, 10
  br i1 %t120, label %B233, label %B123
B118:                               	; preds = %B113
  %t215 = add i32 0, 0
  br label %B115
B123:                               	; preds = %B114
...
B125:                               	; preds = %B124, %B236
  %t130 = load i32*, i32** %t106, align 4
  %t28 = getelementptr inbounds i32, i32* %t130, i32 %t195
  ...
  %t30 = add i32 %t132, 1
  %t25 = getelementptr inbounds i32, i32* %t130, i32 %t195
  ...
  %t137 = icmp slt i32 %t33, %t136
  br i1 %t137, label %B236, label %B140
B129:                               	; preds = %B124
  %t196 = add i32 0, 0
  br label %B126
B140:                               	; preds = %B125
...
B141:                               	; preds = %B126
  %t208 = add i32 1, 0
  %t36 = icmp slt i32 1, 10
  br i1 %t36, label %B142, label %B146
B142:                               	; preds = %B141, %B239
  %t40 = getelementptr inbounds [10 x i32], [10 x i32]* %t109, i32 0, i32 %t208
  ...
  %t38 = getelementptr inbounds [10 x i32], [10 x i32]* %t109, i32 0, i32 %t208
  store i32 %t44, i32* %t38, align 4
  %t47 = add i32 %t208, 1
  %t150 = icmp slt i32 %t47, 10
  br i1 %t150, label %B239, label %B153
B146:                               	; preds = %B141
  %t209 = add i32 1, 0
  br label %B143
B153:                               	; preds = %B142
...
B154:                               	; preds = %B143
  %t201 = add i32 %t49, 0
  %t51 = icmp sgt i32 %t49, 0
  br i1 %t51, label %B155, label %B159
B155:                               	; preds = %B154, %B242
  ...
  %t60 = sub i32 %t162, 1
  %t54 = getelementptr inbounds i32, i32* %t160, i32 %t57
  ...
  %t166 = load i32, i32* %t54, align 4
  %t167 = load i32*, i32** %t107, align 4
  %t169 = load i32, i32* %t54, align 4
  ...
  %t172 = icmp sgt i32 %t57, 0
  br i1 %t172, label %B242, label %B175
B159:                               	; preds = %B154
  %t202 = add i32 %t49, 0
  br label %B156
B175:                               	; preds = %B155
...
B176:
  ...
  %t91 = call i32 @counting_sort(i32* %t74, i32* %t89, i32 %t90)
  br label %B180
B180:                               	; preds = %B176
  %t93 = load i32, i32* @n, align 4
  %t228 = add i32 0, 0
  %t221 = add i32 %t91, 0
  %t94 = icmp slt i32 %t91, %t93
  br i1 %t94, label %B181, label %B185
B181:                               	; preds = %B180, %B246
  %t98 = getelementptr inbounds [10 x i32], [10 x i32]* %t179, i32 0, i32 %t221
  %t187 = load i32, i32* %t98, align 4
  call void @putint(i32 %t187)
  call void @putch(i32 10)
  %t104 = add i32 %t221, 1
  %t189 = load i32, i32* @n, align 4
  %t190 = icmp slt i32 %t104, %t189
  br i1 %t190, label %B246, label %B193
B185:                               	; preds = %B180
  %t227 = add i32 0, 0
  %t220 = add i32 %t91, 0
  br label %B182
