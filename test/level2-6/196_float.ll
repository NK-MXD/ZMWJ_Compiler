...
B167:
  ...
  %t55 = sitofp i32 %t53 to float
  %t54 = fmul float %t51, %t55
...
B218:                               	; preds = %B217, %B225
  ...
  %t121 = getelementptr inbounds [10 x float], [10 x float]* %t228, i32 0, i32 0
  %t122 = call i32 @getfarray(float* %t121)
  store i32 %t122, i32* %t240, align 4
  br label %B241
B219:                               	; preds = %B221
  %t116 = icmp ne float 0.300000, 0.000000
  br i1 %t116, label %B217, label %B225
B241:                               	; preds = %B218, %B242
  %t124 = load i32, i32* %t226, align 4
...
B242:                               	; preds = %B241
  ...
  %t141 = load i32, i32* %t227, align 4
  %t142 = getelementptr inbounds [10 x float], [10 x float]* %t228, i32 0, i32 %t141
  %t250 = load float, float* %t142, align 4
  %t143 = load float, float* %t247, align 4
  %t144 = fadd float %t250, %t143
  %t139 = load i32, i32* %t227, align 4
  %t140 = getelementptr inbounds [10 x float], [10 x float]* %t228, i32 0, i32 %t139
  ...
  call void @putch(i32 10)
  %t149 = load i32, i32* %t226, align 4
  %t153 = sitofp i32 %t149 to float
  %t150 = fsub float 0.000000, 10.000000
  %t151 = fsub float 0.000000, %t150
  %t152 = fmul float %t153, %t151
  %t154 = fptosi float %t152 to i32
  store i32 %t154, i32* %t226, align 4
  %t156 = load i32, i32* %t227, align 4
  %t157 = add i32 %t156, 1
  store i32 %t157, i32* %t227, align 4
  br label %B241
B246:                               	; preds = %B241
  br label %B243
B243:                               	; preds = %B246
  %t158 = load i32, i32* %t240, align 4
  %t159 = getelementptr inbounds [10 x float], [10 x float]* %t228, i32 0, i32 0
  call void @putfarray(i32 %t158, float* %t159)
  ret i32 0
}
