...
B286:
  ...
  %t72 = add i32 %t290, 1
  %t291 = load i32*, i32** %t287, align 4
  %t70 = getelementptr inbounds i32, i32* %t291, i32 0
  store i32 %t72, i32* %t70, align 4
  %t75 = load i32, i32* %t288, align 4
  %t292 = load i32*, i32** %t287, align 4
  %t293 = load i32*, i32** %t287, align 4
  %t73 = getelementptr inbounds i32, i32* %t293, i32 0
  %t294 = load i32, i32* %t73, align 4
  %t74 = getelementptr inbounds i32, i32* %t292, i32 %t294
...
B295:
  ...
  %t299 = load i32*, i32** %t296, align 4
  %t78 = getelementptr inbounds i32, i32* %t299, i32 0
  %t300 = load i32, i32* %t78, align 4
  %t79 = getelementptr inbounds i32, i32* %t298, i32 %t300
  %t301 = load i32, i32* %t79, align 4
  store i32 %t301, i32* %t297, align 4
  %t302 = load i32*, i32** %t296, align 4
  %t82 = getelementptr inbounds i32, i32* %t302, i32 0
  %t303 = load i32, i32* %t82, align 4
  %t83 = sub i32 %t303, 1
  %t304 = load i32*, i32** %t296, align 4
  %t81 = getelementptr inbounds i32, i32* %t304, i32 0
  store i32 %t83, i32* %t81, align 4
  %t84 = load i32, i32* %t297, align 4
  ret i32 %t84
}
...
B305:
  ...
  %t308 = load i32*, i32** %t306, align 4
  %t87 = getelementptr inbounds i32, i32* %t308, i32 0
...
B355:                               	; preds = %B354, %B399
  ...
  store i32 %t135, i32* %t360, align 4
  %t137 = load i32, i32* %t360, align 4
...
B410:                               	; preds = %B409, %B410
  %t179 = getelementptr inbounds [256 x i32], [256 x i32]* %t347, i32 0, i32 0
  %t180 = call i32 @stack_pop(i32* %t179)
  store i32 %t180, i32* %t415, align 4
  %t182 = getelementptr inbounds [256 x i32], [256 x i32]* %t345, i32 0, i32 0
  %t183 = call i32 @stack_pop(i32* %t182)
  store i32 %t183, i32* %t416, align 4
  %t185 = getelementptr inbounds [256 x i32], [256 x i32]* %t345, i32 0, i32 0
  %t186 = call i32 @stack_pop(i32* %t185)
  store i32 %t186, i32* %t417, align 4
  %t188 = getelementptr inbounds [256 x i32], [256 x i32]* %t345, i32 0, i32 0
  %t189 = load i32, i32* %t415, align 4
  %t190 = load i32, i32* %t417, align 4
  %t191 = load i32, i32* %t416, align 4
  %t192 = call i32 @eval_op(i32 %t189, i32 %t190, i32 %t191)
  call void @stack_push(i32* %t188, i32 %t192)
  %t418 = getelementptr inbounds [256 x i32], [256 x i32]* %t347, i32 0, i32 0
  %t419 = call i32 @stack_size(i32* %t418)
  %t420 = icmp ne i32 %t419, 0
  br i1 %t420, label %B410, label %B422
B413:                               	; preds = %B409
  br label %B411
B391:                               	; preds = %B368, %B369
  ...
  %t387 = load i32, i32* %t360, align 4
  %t388 = call i32 @get_op_prec(i32 %t387)
...
B369:                               	; preds = %B391
  ...
  store i32 %t153, i32* %t378, align 4
  %t155 = getelementptr inbounds [256 x i32], [256 x i32]* %t345, i32 0, i32 0
  %t156 = call i32 @stack_pop(i32* %t155)
  store i32 %t156, i32* %t379, align 4
  %t158 = getelementptr inbounds [256 x i32], [256 x i32]* %t345, i32 0, i32 0
  %t159 = call i32 @stack_pop(i32* %t158)
  store i32 %t159, i32* %t380, align 4
  %t161 = getelementptr inbounds [256 x i32], [256 x i32]* %t345, i32 0, i32 0
  %t162 = load i32, i32* %t378, align 4
  %t163 = load i32, i32* %t380, align 4
  %t164 = load i32, i32* %t379, align 4
  %t165 = call i32 @eval_op(i32 %t162, i32 %t163, i32 %t164)
  call void @stack_push(i32* %t161, i32 %t165)
  %t381 = getelementptr inbounds [256 x i32], [256 x i32]* %t347, i32 0, i32 0
  %t382 = call i32 @stack_size(i32* %t381)
...
B370:                               	; preds = %B373, %B393, %B397
  ...
  %t167 = load i32, i32* %t360, align 4
...
B424:
  ...
  store i32 %t195, i32* %t425, align 4
  %t197 = call i32 @getch()
  %t198 = call i32 @next_token()
  br label %B426
B426:                               	; preds = %B424
  %t199 = load i32, i32* %t425, align 4
  %t200 = icmp ne i32 %t199, 0
  br i1 %t200, label %B427, label %B430
B427:                               	; preds = %B426, %B427
  %t201 = call i32 @eval()
  call void @putint(i32 %t201)
  call void @putch(i32 10)
  %t203 = load i32, i32* %t425, align 4
  %t204 = sub i32 %t203, 1
  store i32 %t204, i32* %t425, align 4
  %t432 = load i32, i32* %t425, align 4
  %t433 = icmp ne i32 %t432, 0
  br i1 %t433, label %B427, label %B435
B430:                               	; preds = %B426
  br label %B428
B435:                               	; preds = %B427
  br label %B428
