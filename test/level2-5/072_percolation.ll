...
B177:                               	; preds = %B174
  ...
  %t9 = add i32 %t8, 1
  %t324 = add i32 1, 0
  %t10 = icmp sle i32 1, %t9
  br i1 %t10, label %B178, label %B182
B178:                               	; preds = %B177, %B414
  %t13 = sub i32 0, 1
  %t12 = getelementptr inbounds [110 x i32], [110 x i32]* @array, i32 0, i32 %t324
  ...
  %t187 = add i32 %t186, 1
  %t188 = icmp sle i32 %t16, %t187
  br i1 %t188, label %B414, label %B191
B182:                               	; preds = %B177
  %t325 = add i32 1, 0
  br label %B179
B191:                               	; preds = %B178
...
B203:
  ...
  %t43 = icmp ne i32 %t36, %t39
  br i1 %t43, label %B208, label %B212
B208:                               	; preds = %B203
  %t45 = getelementptr inbounds [110 x i32], [110 x i32]* @array, i32 0, i32 %t36
...
B233:                               	; preds = %B228
  ...
  %t79 = mul i32 %t76, %t78
  %t81 = add i32 %t79, %t73
  %t84 = getelementptr inbounds [110 x i32], [110 x i32]* @array, i32 0, i32 %t81
  store i32 %t81, i32* %t84, align 4
  %t87 = icmp eq i32 %t71, 1
...
B240:                               	; preds = %B233
  ...
  call void @mmerge(i32 %t81, i32 0)
  br label %B241
B244:                               	; preds = %B233
  br label %B241
...
B313:                               	; preds = %B312, %B316
  ...
  %t338 = add i32 10, 0
  %t332 = add i32 %t56, 0
  %t319 = icmp ne i32 %t56, 0
  br i1 %t319, label %B219, label %B321
B245:                               	; preds = %B241
  %t94 = getelementptr inbounds [110 x i32], [110 x i32]* @array, i32 0, i32 %t65
  store i32 %t65, i32* %t94, align 4
  call void @mmerge(i32 %t81, i32 %t65)
  br label %B246
B249:                               	; preds = %B241
  br label %B246
B321:                               	; preds = %B313
...
B250:                               	; preds = %B252
  %t109 = add i32 %t81, 1
  call void @mmerge(i32 %t81, i32 %t109)
  br label %B251
B259:                               	; preds = %B252
  br label %B251
B251:                               	; preds = %B250, %B255, %B259
  %t111 = icmp sgt i32 %t73, 1
...
B270:                               	; preds = %B272
  ...
  %t134 = add i32 %t81, %t133
  call void @mmerge(i32 %t81, i32 %t134)
  br label %B271
B279:                               	; preds = %B272
  br label %B271
B271:                               	; preds = %B270, %B275, %B279
  %t136 = icmp sgt i32 %t71, 1
  br i1 %t136, label %B282, label %B285
B282:                               	; preds = %B271
  %t138 = load i32, i32* @n, align 4
  %t139 = sub i32 %t81, %t138
...
B280:                               	; preds = %B282
  ...
  %t147 = sub i32 %t81, %t146
  call void @mmerge(i32 %t81, i32 %t147)
  br label %B281
B289:                               	; preds = %B282
  br label %B281
...
B293:                               	; preds = %B281
  %t152 = getelementptr inbounds [110 x i32], [110 x i32]* @array, i32 0, i32 %t65
  %t298 = load i32, i32* %t152, align 4
  %t153 = sub i32 0, 1
  %t154 = icmp ne i32 %t298, %t153
  br i1 %t154, label %B292, label %B301
B297:                               	; preds = %B281
  %t401 = add i32 %t405, 0
  %t371 = add i32 %t375, 0
  br label %B291
B292:                               	; preds = %B293
  ...
  %t158 = call i32 @findfa(i32 %t65)
  %t159 = icmp eq i32 %t156, %t158
  br i1 %t159, label %B290, label %B304
B301:                               	; preds = %B293
  %t401 = add i32 %t405, 0
  %t371 = add i32 %t375, 0
  br label %B291
B291:                               	; preds = %B290, %B297, %B301, %B304
  %t403 = add i32 %t401, 0
  %t390 = add i32 %t81, 0
  %t373 = add i32 %t371, 0
  br label %B234
