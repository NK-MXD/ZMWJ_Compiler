...
B60:
  %t11 = call i32 @getint()
  %t13 = icmp sgt i32 %t11, 10
  br i1 %t13, label %B65, label %B68
B65:                               	; preds = %B60
  %t15 = call i32 @func(i32 %t11)
...
B64:                               	; preds = %B62, %B63
  %t21 = call i32 @getint()
  %t23 = icmp sgt i32 %t21, 11
  br i1 %t23, label %B75, label %B78
B75:                               	; preds = %B64
  %t25 = call i32 @func(i32 %t21)
...
B84:                               	; preds = %B82, %B83
  %t41 = call i32 @getint()
  %t43 = icmp sle i32 %t41, 100
  br i1 %t43, label %B92, label %B98
B85:                               	; preds = %B88
  %t35 = call i32 @func(i32 %t31)
