...
B225:                               	; preds = %B219
  br label %B218
B242:                               	; preds = %B241, %B242
  %t272 = phi float[ 0 , %B241 ], [ %t136 , %B242 ]
  %t269 = phi float[ 0 , %B241 ], [ %t133 , %B242 ]
  %t266 = phi float[ 0 , %B241 ], [ %t127 , %B242 ]
  %t261 = phi i32[ 0 , %B241 ], [ %t157 , %B242 ]
  %t257 = phi i32[ 1 , %B241 ], [ %t154 , %B242 ]
  %t127 = call float @getfloat()
  %t129 = load float, float* @PI, align 4
  %t131 = fmul float %t129, %t127
  %t133 = fmul float %t131, %t127
  %t137 = fptosi float %t127 to i32
  %t136 = call float @circle_area(i32 %t137)
  %t142 = getelementptr inbounds [10 x float], [10 x float]* %t228, i32 0, i32 %t261
  %t250 = load float, float* %t142, align 4
  %t144 = fadd float %t250, %t127
  %t140 = getelementptr inbounds [10 x float], [10 x float]* %t228, i32 0, i32 %t261
  store float %t144, float* %t140, align 4
  call void @putfloat(float %t133)
  call void @putch(i32 32)
  %t147 = fptosi float %t136 to i32
  call void @putint(i32 %t147)
  call void @putch(i32 10)
  %t153 = sitofp i32 %t257 to float
  ...
  br i1 %t253, label %B242, label %B256
B246:                               	; preds = %B241
  br label %B243
B256:                               	; preds = %B242
  br label %B243
B243:                               	; preds = %B246, %B256
  %t272 = phi float[ 0 , %B246 ], [ %t136 , %B256 ]
  %t269 = phi float[ 0 , %B246 ], [ %t133 , %B256 ]
  %t266 = phi float[ 0 , %B246 ], [ %t127 , %B256 ]
  %t261 = phi i32[ 0 , %B246 ], [ %t157 , %B256 ]
  %t257 = phi i32[ 1 , %B246 ], [ %t154 , %B256 ]
