...
B980:                               	; preds = %B983, %B989
  ...
  store i32 %t517, i32* %t916, align 4
  %t519 = getelementptr inbounds [32 x i32], [32 x i32]* %t915, i32 0, i32 0
  %t520 = call i32 @avgPooling(i32* %t519, i32 3)
  store i32 %t520, i32* %t916, align 4
  store i32 0, i32* %t917, align 4
  br label %B990
B990:                               	; preds = %B980
  %t522 = load i32, i32* %t917, align 4
  %t523 = icmp slt i32 %t522, 32
  br i1 %t523, label %B991, label %B995
B991:                               	; preds = %B990, %B991
  %t525 = load i32, i32* %t917, align 4
  %t526 = getelementptr inbounds [32 x i32], [32 x i32]* %t915, i32 0, i32 %t525
  %t996 = load i32, i32* %t526, align 4
  store i32 %t996, i32* %t916, align 4
  %t527 = load i32, i32* %t916, align 4
  call void @putint(i32 %t527)
  %t529 = load i32, i32* %t917, align 4
  %t530 = add i32 %t529, 1
  store i32 %t530, i32* %t917, align 4
  %t997 = load i32, i32* %t917, align 4
  %t998 = icmp slt i32 %t997, 32
  br i1 %t998, label %B991, label %B1001
B995:                               	; preds = %B990
  br label %B992
B1001:                               	; preds = %B991
  br label %B992
